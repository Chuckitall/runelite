package net.runelite.client.plugins.fredexperimental.oneclick2.lua.libs;
...
@Slf4j
public class InventoryQueryLib<E extends ScriptPlugin> extends TwoArgFunction
{
	private E plugin;
	public InventoryQueryLib(E plugin)
	{
		this.plugin = plugin;
	}
