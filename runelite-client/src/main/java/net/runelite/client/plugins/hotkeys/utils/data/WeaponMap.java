...
public class WeaponMap
{
	...
	{
		MAGIC, RANGE, MELEE, MAGEBUTDONTCAST;
		//MELEE(0), RANGE(1), MAGIC(2);

		/*private final int value;

		WeaponStyle(final int newValue)
		{
			value = newValue;
		}
	...
	public static HashMap<Integer, WeaponStyle> StyleMap = new HashMap<Integer, WeaponStyle>();
	...
	static
	{
		...
		StyleMap.put(ItemID.DAWNBRINGER, WeaponStyle.MAGEBUTDONTCAST);
		StyleMap.put(ItemID.DRAMEN_STAFF, WeaponStyle.MAGEBUTDONTCAST);
		...
		StyleMap.put(ItemID.LUNAR_STAFF, WeaponStyle.MAGEBUTDONTCAST);
		...
		//what the fuck...
		StyleMap.put(ItemID.GNOMEBALL, WeaponStyle.MAGEBUTDONTCAST);
	}
}
